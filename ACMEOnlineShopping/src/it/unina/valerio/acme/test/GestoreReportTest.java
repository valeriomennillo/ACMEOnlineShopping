...
public class GestoreReportTest {
	...
	public void testNPositivoListaClienteNullListaSpeseNullNSpeseIndefinitoSpesaTotaleIndefinita() {
		int N = 1;
		Report actual = gestoreReport.generaReport(N, null, null);
	...
	public void testNPositivoListaClienteVuotaListaSpeseVuotaNSpese0SpesaTotale0() {
		int N = 1;
		Report actual = gestoreReport.generaReport(N, lista_clienti, lista_spese);
		// gestoreReport.visualizzaReport(actual);
		assertEquals(r.toString(), actual.toString());
	}
	...
	public void testN0ListaClienteNonVuotaListaSpeseNonVuotaNSpesePositivoGreaterNSpesaTotale0()
		...
		Report actual = gestoreReport.generaReport(0, lista_clienti, lista_spese);
		r.addRecord(0, 1, 1.0F);
		r.addRecord(0, 1, 1.0F);
		//gestoreReport.visualizzaReport(actual);
		assertEquals(r.toString(), actual.toString());
	...
	// TestCaseID:9
	@Test
	public void testNPositivoListaClienteNonVuotaListaSpeseNonVuotaNSpesePositivoNSpesaTotalePositiva()
			throws NegativePriceException {
